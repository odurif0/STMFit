# -----------------------------------------------------------------------------
# SXM reader — owned by STMSXMIO (imported in GaussianFit2D.jl).
# Low-level preprocessing helpers (_plane_fit, _row_median_flatten via
# _row_median_flatten_global, _box_smooth, _otsu_threshold, _largest_component,
# _dilate_mask, _coordinate_vectors, _value_scale) are also imported from
# STMSXMIO and are not redefined here.
# -----------------------------------------------------------------------------
